...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="flex min-h-full flex-col font-sans bg-white antialiased">
        <section
          className="bg-white"
          aria-labelledby="global-app-error-heading"
        >
          <div className="general-container general-padding-x flex flex-col gap-16 py-16 sm:py-24">
            <div className="flex max-w-4xl flex-col items-start text-left">
              <p
                ...
                id="global-app-error-kicker"
              >
                Error
              </p>
              <h1
                id="global-app-error-heading"
              ...
              <p className="mb-10 max-w-lg text-lg font-normal leading-relaxed text-gray-500 sm:mb-8 sm:text-lg">
                An unexpected error occurred while loading the site. You can try
